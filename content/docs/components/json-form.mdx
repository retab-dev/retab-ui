...
| `readOnly`   | `boolean`                                  | Render every control inert — values stay visible and selectable, but nothing can be edited and the array add/remove affordances are dropped. Use it on viewer surfaces that never submit. |
