...
description: A compact color key for page-segmented document results, with bar, floating, inset, and rail variants.
---
...
document surface in four flavors: a flush **bar**, a **floating** overlay card, a
gapped **inset** panel, or a vertical **rail**.
...
| `variant` | `"bar" \| "floating" \| "inset" \| "plain"` | How the legend attaches to the surface. Defaults to `"bar"`. |
