...
The XLSX Viewer renders an Excel workbook the way the [PDF Viewer](/docs/components/file-viewer/renderers/pdf)
...
<ComponentPreview name="xlsx-viewer-demo" contentClassName="p-0" />
...
<ComponentSource src="registry/new-york-v4/ui/xlsx-viewer.tsx" />
