...
zoom, fit-to-width, and download. It mirrors the [PDF Viewer](/docs/components/file-viewer/renderers/pdf)
...
<ComponentPreview name="docx-viewer-demo" contentClassName="p-0" />
...
<ComponentSource src="registry/new-york-v4/ui/docx-viewer.tsx" />
