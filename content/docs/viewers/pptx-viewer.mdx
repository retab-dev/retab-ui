...
The PPTX Viewer renders a PowerPoint deck the same way the [PDF Viewer](/docs/viewers/pdf-viewer)
...
The API mirrors the [PDF Viewer](/docs/viewers/pdf-viewer) — `pageNumber` is a
1-based slide index.
