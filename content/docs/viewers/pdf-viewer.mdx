...
default when a rail is set; control with `railToggle` / `defaultRailsOpen`).
`asideToggle` and `defaultAsideOpen` remain compatibility aliases.
...
| `railToggle`             | `boolean`                                | Show a toolbar button that collapses/expands the rails. Defaults to `true` when a rail is set.                     |
| `defaultRailsOpen`       | `boolean`                                | Initial open state of the rails. Defaults to `true`.                                                               |
| `asideToggle`            | `boolean`                                | Compatibility alias for `railToggle`.                                                                              |
| `defaultAsideOpen`       | `boolean`                                | Compatibility alias for `defaultRailsOpen`.                                                                        |
