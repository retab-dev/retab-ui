...
flowchart TD
  ...
  subgraph callers["External Callers / Consumers"]
    ...
    doc_thumb["components/file-thumbnail/renderers/pdf-thumbnail.tsx<br/>first-page PDF thumbnail"]
  ...
  subgraph thumbnails["PDF Thumbnail Consumers Sharing the Cache"]
    thumb_sidebar["PdfViewerThumbnails<br/>source: URL only<br/>createViewerResource({ kind: url, url: src })<br/>inline ViewerErrorBoundary"]
    thumb_inner["PdfViewerThumbnailsInner<br/>readDocumentResource<br/>retain/release document<br/>renders one button per page"]
...
| PDF cache consumers          | `registry/new-york-v4/ui/pdf-viewer-thumbnails.tsx`, `components/file-thumbnail/renderers/pdf-thumbnail.tsx`                                                                                                                                                                                                                                                                        |
