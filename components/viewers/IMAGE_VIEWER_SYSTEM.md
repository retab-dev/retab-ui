...
flowchart TD
  subgraph PublicSurface["Public and install surface"]
    ...
    Docs["content/docs/components/file-viewer/image-viewer.mdx\n- install command\n- usage example\n- performance model\n- props table"]
...
| Docs and demo      | `content/docs/components/file-viewer/image-viewer.mdx`, `components/image-viewer-demo.tsx`                                 | User-facing install, usage, performance explanation, prop table, and TIFF sample.                                                          |
