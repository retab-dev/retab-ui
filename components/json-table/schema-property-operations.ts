...
function updatePropertyAtPath(
  ...
  function updateInBase(
    ...
    if (segments.length === 0) {
      ...
      return updateInNode(
        baseNode as ExtendedJSONSchema7,
...
export async function applyTemplateToTableSchemaProperty(
  ...
  const { objectTemplateDependencies, templateObjects } = await import(
    "@/components/schema-editor/optional/object-templates/template-objects"
  );
